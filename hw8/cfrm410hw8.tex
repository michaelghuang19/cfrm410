...
We aim to find $P(X = x, Y = y)$. Because of the way that $Y$ relies on $X$, we can use the definition of conditional probability to simplify this to $P(X = x, Y = y) = P(Y = y \mid X = x)P(X = x) = \frac{1}{x} \cdot \frac{1}{5} = $ \framebox[1.1\width]{\textbf{$\frac{1}{5x}$}}, since the distribution of $X$ is a uniform one across 5 numbers, and $P(Y = y)$ is determined by this initial choice of $x$. We note that this only holds when $x \geq y$, by definition, and is 0 elsewhere.
...
$Var(Y) = $ \framebox[1.1\width]{\textbf{$(\frac{1}{2})^n(1-(\frac{1}{2})^n) + (\frac{2}{3})^n(1-(\frac{2}{3})^n) + (\frac{5}{6})^n(1-(\frac{5}{6})^n) + 2((\frac{1}{6})^n - (\frac{1}{3})^n)$}} \\
\framebox[1.1\width]{\textbf{$+ 2((\frac{1}{3})^n - (\frac{5}{12})^n) + 2((\frac{1}{2})^n - (\frac{5}{9})^n)$}}

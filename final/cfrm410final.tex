...
\framebox[1.1\width]{\textbf{$f(y) = -ln(0.6)0.6y$}}
...
$= P(G_1 \leq t) \cdot P(G_2 \leq t) \cdot P(G_3 \leq t) \cdot P(G_4 \leq t) = (1-\frac{1}{t^4})^4$. Our cdf is therefore \framebox[1.1\width]{\textbf{$(1-\frac{1}{t^4})^4$}} \\ \\
To find our pdf, we simply differentiate: $\frac{d}{dt} (1-\frac{1}{t^4})^4 = 4(1 - \frac{1}{t^4})^3 \cdot \frac{4}{t^5} = $  \framebox[1.1\width]{\textbf{$\frac{16(t^4-1)^3}{t^{17}}$}} \\ 

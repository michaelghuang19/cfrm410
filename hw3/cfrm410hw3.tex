...
Putting this all together, we can thusly find that $P(K_S \mid K) = P(K_S \cap K) \div P(K) = \frac{1}{602} \div \frac{4}{43} = $ \framebox[1.1\width]{$\frac{1}{56}$} in general, or simply 0 in the case that the king we pull on the 10th card is a king of spades.
...
Putting this all together, we find that $\frac{P(N = 2 \cap S = 4)}{P(S = 4)} = \frac{1}{48} \div \frac{2197}{20736} =$ \framebox[1.1\width]{\textbf{$\frac{432}{2197}$ or approximately 0.1966}}
...
We can now plug it in to find $P(S = 4 \mid N_{even}) = \frac{P(S = 4 \cap N_{even})}{P(N_{even})} = \frac{433}{20736} \div \frac{1}{3} = $ \framebox[1.1\width]{\textbf{$\frac{433}{6912}$ or approximately 0.0626}}

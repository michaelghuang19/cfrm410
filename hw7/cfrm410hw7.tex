...
The used car has been driven 10,000 miles, so we simply aim to find P$(X > 10,000 + 20,000 \mid X > 10,000) = P(X > 30,000 - 10,000) = P(X > 20,000) = e^{-\lambda \cdot a} = e^{-\frac{1}{20,000} \cdot 20,000} = e^{-1} = $ \framebox[1.1\width]{\textbf{$\frac{1}{e}$}} \\ 
...
$\frac{P(X > 30,000)}{P(X > 10,000)} = \frac{1 - \text{P}(X \leq 30,000)}{1 - \text{P}(X \leq 10,000)} = \frac{1 - \frac{30,000}{40,000}}{1 - \frac{10,000}{40,000}} = \frac{\frac{1}{4}}{\frac{3}{4}} = $ \framebox[1.1\width]{\textbf{$\frac{1}{3}$}}
...
$= e^{-x}$ \\ \\
We have that \framebox[1.1\width]{\textbf{$f_x = e^{-x}$ for $0 < x < \infty$ and 0 otherwise}}, which by definition allows us to identify that $X$ an \\ \framebox[1.1\width]{\textbf{exponential distribution}}.
...
= \framebox[1.1\width]{\textbf{$\frac{e^{-t}}{2}$}}
...
$ = $ \framebox[1.1\width]{\textbf{$1 - 3e^{-2}$}}
